function iniciarApp(){
    ...
    function mostrarRecetas(recetas = []){
        ...
        heading.textContent = recetas.length ? 'Resultados:' : 'No hay resultados disponibles';
        ...
        recetas.forEach(receta => {
            ...
            recetaButton.classList.add('btn', 'btn-danger', 'w100');
    ...
    function mostrarRecetaModal(receta){
        ...
        modalBody.innerHTML = `
            ...
            btnFavorito.onclick = function(){
                ...
                mostrarToast('Guardado de manera exitosa');
